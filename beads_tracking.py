...
n_frames = 50000
dt = 10e-3 # in s, frame real time of the acquisition (might be different from exp time!)
w = 10 # how many frames are we going to average for the low-freq drift (w*dt should roughly correspond to a DNA-PAINT frame)
...
n = 20 # interval at which display points in the plot
